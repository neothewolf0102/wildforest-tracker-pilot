...
NORMAL_ACCOUNTS_PER_USER = 5
MAX_ACCOUNTS_PER_USER = NORMAL_ACCOUNTS_PER_USER
...
def upsert_account(
    ...
    if existing_index is None and not bypass_account_limit and len(accounts) >= NORMAL_ACCOUNTS_PER_USER:
